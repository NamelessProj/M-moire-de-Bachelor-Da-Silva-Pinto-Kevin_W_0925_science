...
\subsection{Cycle de développement itératif (PDCA)} \label{devPDCA}
...
Le développement s'est déroulé en trois étapes d'itérations successives, décrites en détail au chapitre \ref{MediaProject}:
