...
L'utilisation de \gls{ts} comme surcouche typée de \gls{js} permet de détecter à la compilation un ensemble d'erreurs de type qui seraient silencieuses en \gls{js} pur. Combiné à la validation \gls{zod} à l'exécution, ce dispositif forme une double barrière contre les états invalides du moteur.
