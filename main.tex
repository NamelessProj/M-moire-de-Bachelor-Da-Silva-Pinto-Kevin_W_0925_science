...
\addbibresource{cite.bib} % note the .bib is required
    ...
    \begin{center}
        ...
        \begin{mdframed}
            \begin{center}
                ...
                \textbf{Création d'une librairie React.js pour une meilleure accessibilité.}
            \end{center}
        \end{mdframed}
...
\cite{bosser_systematic_2020}

\cite{camingue_what_2021}

\cite{nguyen_creating_2019}
